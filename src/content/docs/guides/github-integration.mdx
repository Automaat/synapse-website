...
- **Mark ready** — flips a draft PR to ready-for-review
- **Fix CI** — dispatches a headless agent on the PR's branch to fix red CI
- **Request review** — requests a review from the configured reviewers
- **Merge** — merges via GraphQL (respects branch protection)

...
Location: `~/.sybra/config.yaml`. Reloaded on file change (fsnotify). Env substitution (`$VAR`, `${VAR}`) happens at load time.
...
# ─────────────────────────────────────────────────────────────
# Server (only consulted by sybra-server)
# ─────────────────────────────────────────────────────────────
server:
  bearer_token: ""
...
| `api_token` | string | Personal API token. Use env substitution. |
...
Substitution at load time. Missing vars render as empty strings.
